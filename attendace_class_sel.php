...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Student Attendace</a></li>
...
<tr>
  ...
  <tr>
                  ...
                  <td><a class="btn  btn-outline-info" href="student_attendace.php?table_name=<?php echo $row['table_name'] ?>"><i class="fa-solid fa-person"></i>View</a></td>
