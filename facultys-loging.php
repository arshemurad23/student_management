...
if(isset($_POST['add'])){
  ...
  $que = "select * from teacher_details  where username = '$uname' limit 1 ";
...
if($pass == $row['pasword']){
  ...
  header('location:attendace_class_sel.php');
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login to Faculty</h5>
...
<br>
                              <p>Longin for others accounts <a href="fee-system-login.php">Fees Management</a> & <a href="pages-login.php">Admin</a> </p>
