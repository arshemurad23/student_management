...
if($uname != "" && $pname != "" && $pass != "" && $cpass != ""){
  ...
  $select_que = "select count(*) from  teacher_details  where username = '$uname' and primary_name = '$pname' ";
  $res = mysqli_query($con,$select_que);
$row = mysqli_fetch_array($res);
  if($row[0]>0){


$update_que = "update  teacher_details set pasword = '$pass' , cpasword = '$cpass' where username = '$uname'";
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Enter your username & primary & password then Submit</p>
                  </div>
