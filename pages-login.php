...
if(isset($_POST['add'])){
  ...
  $que = "select * from signup  where uname = '$uname' limit 1 ";
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login only Admin</h5>
...
<br>
                              <p>Longin for others accounts <a href="fee-system-login.php">Fees Management</a> & <a href="facultys-loging.php">Facultys</a> </p>
