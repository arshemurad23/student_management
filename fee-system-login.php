...
if(isset($_POST['add'])){
  ...
  $que = "select * from fee_user  where username = '$uname' limit 1 ";
...
if($pass == $row['pasword']){
  ...
  $_SESSION['uname'] = $row['username'];
   $_SESSION['pname'] = $row['primary_name'];
  $_SESSION['pic'] = $row['img'];

  header('location:student_fee_class_view.php');
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Login only Fee Management Depart</h5>
                  ...
                  <form class="row g-3 needs-validation" method="post" novalidate>
                    ...
                    <div class="col-12">
                      <button name="add" class="btn btn-primary w-100" type="submit">Login</button>
                    </div>
                                  </form>
<br>
                              <p>Longin for others accounts <a href="pages-login.php">Admin</a> & <a href="facultys-loging.php">Facultys</a> </p>
